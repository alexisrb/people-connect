                                                ...
                                                <tr>
                                                    ...
                                                    @for($i=0; $i < $number_jornaulis; $i++)
                                                        <td class="border-left">
                                                            <div form-group>
                                                                <select class="w-100" id="day_entrada{$i}" name="day_entrada[]" required wire:model="day_entrada.{{$i}}">
                                                                ...
                                                                <input type="time" class="form-control border-0" id="entrada{{$i}}" required wire:model="hora_entrada.{{$i}}">
                                                ...
                                                <tr>
                                                    <tr>
                                                        ...
                                                        @for($i=0; $i < $number_jornaulis; $i++)
                                                            <td class="border-left">
                                                                <div form-group>
                                                                    <select class="w-100" id="day_salida{$i}" name="day_salida[]" required wire:model="day_salida.{{$i}}">
                                                                            <option value="">Seleccione el día</option>
                                                                            <option>Lunes</option>
                                                                            <option>Martes</option>
                                                                            <option>Miércoles</option>
                                                                    ...
                                                                    <input type="time" class="form-control border-0" id="salida{{$i}}" required wire:model="hora_salida.{{$i}}">
