                        ...
                        <div class="col m-2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <input type="number" id="ram" class="form-control" wire:model="ram" placeholder="Ingrese los gigabytes de RAM">
                                    @error('ram') <span class="text-danger error">{{ $message }}</span>@enderror
                                </div>
                                ...
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <input type="text" id="procesador" class="form-control" wire:model="procesador" placeholder="Ingrese el procesador">
                                    @error('procesador') <span class="text-danger error">{{ $message }}</span>@enderror
                                </div>
                                ...
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <input type="text" id="targeta_gráfica" class="form-control" wire:model="targeta_gráfica" placeholder="Ingrese la targeta grafica">
                                    @error('targeta_gráfica') <span class="text-danger error">{{ $message }}</span>@enderror
                                </div>
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" id="sistema_operativo" class="form-control" wire:model="sistema_operativo" placeholder="Ingrese el sistema operativo">
