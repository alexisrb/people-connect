...
return [
    ...
    */
    ...
    'logo_img' => 'vendor/adminlte/dist/img/.svg',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/.svg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'shift'   => 'ml-3',
                    'route'         => 'admin.justifications.index',
                    'icon' => 'fas fa-solid fa-clock',
                    'can' => 'admin.justifications.index'
                ],
                [
                    'text'        => 'CALENDARIO',
                    'shift'   => 'ml-3',
                ...
                [
                    'text'        => 'HORAS EXTRAS EXTRAORDINARIAS Y TRANSPORTISTAS',
                    'shift'   => 'ml-3',
                    'route'         => 'admin.extraordinary.index',
                    'icon' => 'fas fa-solid fa-plus-minus',
                ...
                [
                    'text'        => 'PASE DE LISTA',
                    'shift'   => 'ml-3',
                    'route' => 'admin.check_assitance.index',
                    'icon' => 'fa-solid fa-check-to-slot',
                    'can' => 'admin.check_assitance.index'
                ]
            ],
        ],
        [
